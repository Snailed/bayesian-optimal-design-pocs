...
\begin{equation}\nabla_\B{d} I(\B{d}) = \nabla_\B{d}\mathbb{E}_{\B{y} \sim q^*}[\mathbb{E}_{\B{\theta}\sim q^*}[\log (q^*(\theta)) - \log p(\theta)]]\end{equation}
$$ \approx \mathbb{E}_{\B{\epsilon}\sim q^*}[\mathbb{E}_{\B{z}\sim q^*}[\nabla_\B{d}\log (q^*_{\B{y}', \B{d}}(\theta'))]],$$
...
\begin{equation}
  = \mathbb{E}_{\B{\epsilon}\sim q^*}[\mathbb{E}_{\B{z}\sim q^*}[\frac{1}{q^*_{\B{y}', \B{d}}(\theta')} + \nabla_\B{d} q^*_{\B{y}', \B{d}}(\theta'))]],
\end{equation}
...
\begin{equation}
  \nabla_\B{d} q^*_{\B{y}', \B{d}}(\theta') = \nabla_\lambda q^{\lambda}_{\B{y}', \B{d}}(\theta')\nabla_\B{d} \lambda^*_{\B{y}', \B{d}}
\end{equation}
The gradient, $\nabla_\lambda q^\lambda_{\B{y}',\B{d}}$, is simple to perform using automatical differentiation.
The Jacobian of the variational parameters with regards to the design $\B{d}$, $\nabla_\B{d} \lambda^*_{\B{y}', \B{d}}$, needs very careful consideration. 
...
\begin{theorem}
  ...
  Futhermore, the Jacobian of $g$ in $U$ is given by
  $$$$
\end{theorem}
