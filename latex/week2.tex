...
\begin{equation} \label{eq:mi}\mathbb{E}_\B{y}[H_\textrm{gain}]  = \mathbb{E}_\B{y}[\mathbb{E}_{\theta | \B{y}, \B{d}} [\log(p(\theta | \B{y}, \B{d}))] - \mathbb{E}_{\theta}[\log(p(\theta))]]\end{equation}\todo{To Oswin: In my notes, we put this under one single expectation. This is done with reparameterization, right?}
...
thus  \todo{make z different each iteration}
\begin{equation}
  \label{eq:mi-sampled}
